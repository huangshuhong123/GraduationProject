...
import com.zhku.config.ResourceConfig;
...
//	public static final String ZOOKEEPER_SERVER = "192.168.1.210:2181";
	...
	public void init() {
		...
		// 创建zk客户端
		client = CuratorFrameworkFactory.builder().connectString("192.168.136.130:2181")
		...
		cache.getListenable().addListener(new PathChildrenCacheListener() {
			...
			public void childEvent(CuratorFramework client, PathChildrenCacheEvent event) 
				...
				if (event.getType().equals(PathChildrenCacheEvent.Type.CHILD_ADDED)) {
					...
					String path = event.getData().getPath();  // /bgm
...
//					String filePath = "C:\\imooc_videos_dev" + songPath;
					...
					String filePath ="D:\\video" + songPath;
					// 3. 定义下载的路径（播放url）
...
//					String bgmUrl = "http://192.168.1.2:8080/mvc" + finalPath;
					...
					String bgmUrl = "http://localhost:8090/mvc" + finalPath;
