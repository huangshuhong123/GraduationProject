...
import com.zhku.enums.VideoStatusEnum;
import com.zhku.pojo.Bgm;
import com.zhku.pojo.Comments;
import com.zhku.pojo.Videos;
import com.zhku.service.BgmService;
import com.zhku.service.VideoService;
import com.zhku.utils.FetchVideoCover;
import com.zhku.utils.IMoocJSONResult;
import com.zhku.utils.MergeVideoMp3;
...
//		String fileSpace = "C:/imooc_videos_dev";
		...
		String finalVideoPath2 = "";
		try {
			if (file != null) {
				
				String fileName = file.getOriginalFilename();
				String fileName1 =   "noSound" + file.getOriginalFilename();
				// abc.mp4
...
//				String fileNamePrefix = fileName.split("\\.")[0];
				...
				if (StringUtils.isNotBlank(fileName)) {
					...
					finalVideoPath2 = FILE_SPACE + uploadPathDB + "/" + fileName1;
					// 设置数据库保存的路径
		...
		if (StringUtils.isNotBlank(bgmId)) {
			...
			tool.convertor1(videoInputPath,finalVideoPath2);
			tool.convertor2(finalVideoPath2,mp3InputPath,videoSeconds,finalVideoPath);
		}
...
//		String fileSpace = "C:/imooc_videos_dev";
	...
	public IMoocJSONResult getVideoInfo(@RequestParam("videoId") String videoId){
		Videos video = videoService.getVideoInfo(videoId);
